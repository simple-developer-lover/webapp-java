...
public class DataSourceConfig {
	...
	public DriverDataSource hibernateDataSource() throws IOException {
		...
		Properties properties = PropertiesLoaderUtils.loadAllProperties(propertyFile);
	...
	public DriverDataSource mybatisDataSource() throws IOException {
		String propertyFile = APPUtil.getProjectPath(DataSourceConfig.class) + APPUtil.defaultConfigName;
		Properties properties = PropertiesLoaderUtils.loadAllProperties(propertyFile);
		String jdbcUrl = properties.getProperty("mybatis.jdbcUrl", "jdbc:mysql://localhost:3306/webapp_spider");
		String driverClass = properties.getProperty("mybatis.driverClass", "com.mysql.jdbc.Driver");
		String username = properties.getProperty("mybatis.username", "root");
		String password = properties.getProperty("mybatis.password", "root");
		DriverDataSource dataSource = new DriverDataSource(jdbcUrl, driverClass, properties, username, password);
		return dataSource;
	}*/
